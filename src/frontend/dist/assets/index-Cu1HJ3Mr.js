...
function App() {
  ...
  const gameRef = reactExports.useRef(initGame());
  const rafRef = reactExports.useRef(0);
  const audioRef = reactExports.useRef(null);
  const stadiumImgRef = reactExports.useRef(null);
  const ronaldoImgRef = reactExports.useRef(null);
  const gkImgRef = reactExports.useRef(null);
  const [uiRound, setUiRound] = reactExports.useState(0);
  const [uiGoals, setUiGoals] = reactExports.useState(0);
  ...
  reactExports.useEffect(() => {
    ...
    function drawBg() {
      ...
      if ((stadium == null ? void 0 : stadium.complete) && stadium.naturalWidth > 0) {
    ...
    function drawGK(g) {
      ...
      const w = 80;
      const h = 80;
      if ((gkImg == null ? void 0 : gkImg.complete) && gkImg.naturalWidth > 0) {
    ...
    function tick() {
      ...
      if (g.state === "FLYING") {
        ...
        if (g.ballFrame >= FLIGHT_FRAMES) {
          ...
          const inGoal = g.ballTargetX > GOAL_X + 5 && g.ballTargetX < GOAL_X + GOAL_W - 5 && g.ballTargetY > GOAL_Y + 5 && g.ballTargetY < GOAL_Y + GOAL_H - 5;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("header", { style: { textAlign: "center", marginBottom: "16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "h1",
          {
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fff" }, children: "PENALTY STRIKER" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F2A23A" }, children: " CR7" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { "data-ocid": "game.round.panel", children: [
                "ROUND: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F2A23A" }, children: uiRound || "–" }),
                "/5"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { "data-ocid": "game.goals.panel", children: [
                "GOALS: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F2A23A" }, children: uiGoals })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "canvas",
          {
            ...
            style: {
              ...
              borderRadius: "4px",
              boxShadow: "0 0 40px rgba(242, 162, 58, 0.15), 0 8px 32px rgba(0,0,0,0.6)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "SPACE OR CLICK \\u2192 AIM \\u2192 SHOOT \\u2192 SCORE!"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "footer",
