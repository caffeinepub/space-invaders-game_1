...
function RonaldoGame() {
  ...
  const [displayPhase, setDisplayPhase] = reactExports.useState("intro");
  const [displayScore, setDisplayScore] = reactExports.useState(0);
  const [displayPenalty, setDisplayPenalty] = reactExports.useState(1);
  const [shotResult, setShotResult] = reactExports.useState(null);
  ...
  const handleClick = reactExports.useCallback(() => {
    ...
    if (s.phase === "power") {
      ...
      const relX = (s.lockedX - GOAL_LEFT) / GOAL_W;
      let shotZone;
      ...
      let diveDir = 0;
      if (readsShot) {
        diveDir = shotZone === "left" ? -1 : shotZone === "right" ? 1 : Math.random() < 0.5 ? -1 : 1;
      } else {
        const r = Math.random();
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              color: "#ffffff",
              textShadow: "0 2px 12px rgba(0,0,0,0.8), 0 0 40px rgba(255,200,0,0.3)",
              marginBottom: "6px",
              textAlign: "center"
            },
            children: "🏆 RONALDO PENALTY SHOOTOUT"
          }
        ),
        displayPhase !== "intro" && displayPhase !== "gameover" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              position: "relative",
              cursor: displayPhase === "aim" || displayPhase === "power" ? "crosshair" : "default"
            },
            onClick: displayPhase === "aim" || displayPhase === "power" || displayPhase === "intro" ? handleClick : void 0,
            onKeyDown: displayPhase === "aim" || displayPhase === "power" || displayPhase === "intro" ? (e) => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "canvas",
                {
                  ...
                  style: {
                    display: "block",
                    borderRadius: "8px",
                    boxShadow: "0 8px 40px rgba(0,0,0,0.7), 0 0 0 2px rgba(255,255,255,0.08)",
                    maxWidth: "100vw"
                  }
                }
              ),
              displayPhase === "intro" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    position: "absolute",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          color: "#ffdd00",
                          textShadow: "0 0 30px rgba(255,200,0,0.8), 0 4px 12px rgba(0,0,0,0.8)",
                          letterSpacing: "0.06em",
                          textAlign: "center"
                        },
                        children: "⚽ PENALTY SHOOTOUT"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
              ...
              (displayPhase === "aim" || displayPhase === "power") && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
                  ...
                  children: displayPhase === "aim" ? "🎯 CLICK TO AIM" : "⚡ CLICK TO SHOOT"
                }
              ),
              displayPhase === "result" && msg && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
              ...
              displayPhase === "gameover" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    position: "absolute",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          ...
                          textShadow: finalScore >= 3 ? "0 0 40px #00ff66, 0 0 80px #00cc44" : "0 0 40px #ff3300, 0 0 80px #cc1100",
                          lineHeight: 1,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: getFinalMessage()
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "10px", marginTop: "4px" }, children: records.map((r, i) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            ...
                            justifyContent: "center",
                            fontSize: "14px",
                            boxShadow: r.result === "goal" ? "0 0 10px #00cc44" : "0 0 10px #cc1100"
                          },
                          "data-ocid": `game.item.${penaltyIndex}`,
                          children: r.result === "goal" ? "✓" : "✗"
                        },
                        penaltyIndex
                      );
                    }) }),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(RonaldoGame, {})
    }
  );
}
